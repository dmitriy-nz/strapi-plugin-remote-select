            ...
            ? [
                {
                  ...
                  description: {
                    ...
                    defaultMessage: 'When enabled, save both value and label. When disabled (default), save only value. Single mode: string vs JSON object. Multi mode: array of strings vs JSON array of objects.',
                  },
                },
              ]
            : []),
